      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            statusProcesso: expect.any(Object),
            matricula: expect.any(Object),
            nome: expect.any(Object),
            data: expect.any(Object),
            numeroDaDefesa: expect.any(Object),
            statusSigaa: expect.any(Object),
            numeroSipac: expect.any(Object),
            enviadoBiblioteca: expect.any(Object),
            turma: expect.any(Object),
            entregaDiploma: expect.any(Object),
          })
        );
      });
